...
class crm_extension(models.Model):
    ...
    def write(self, vals):
        ...
        print "111111111111 Lead write 111111111111" , self.type
    ...
    def send_mail(self):
        ...
        if self.sales_user_id:
            ...
            if template_id:
                ...
                if msg_id:
                    print "1111111111111111 Lead send_mail 1111111111111111"
                    msg_id.sudo().send()
...
class project_contacts(models.Model):
    ...
    def create(self, vals):
        ...
        if result.number :
            ...
            mobile = self.env['crm.lead'].search(['|',('mobile','=',result.number),
                ('phone','=',result.number),('type','=','lead')])
    ...
    def write(self, vals):
        ...
        if self.number :
            number = lead = ''
            mobile = self.env['crm.lead'].search(['|',('mobile','=',self.number),
                ('phone','=',self.number),('type','=','lead')])
