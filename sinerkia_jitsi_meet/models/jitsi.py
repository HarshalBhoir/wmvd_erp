...
class JistiMeet(models.Model):
    ...
    def create(self, vals):
        ...
        # print "aaaaaaaaaaaaaaaaaaaaaaaaa" , res , res.send_mail
        # if res.send_mail:
        #     template = self.env.ref('sinerkia_jitsi_meet.email_template_edi_jitsi_meet')
        #     a = self.env['mail.template'].sudo().browse(template.id).send_mail(res.id)
        #     print "bbbbbbbbbbbbbbbbbbbbbbbbb" ,template , a
