        ...
        for rec in credit_note_line_filter:
            ...
            payment_body = """<_0:serviceType>CreateCompleteCreditNote</_0:serviceType>
                <_0:operations>
                    ...
                    </_0:operation>"""  % ( org_id ,C_DocTypeTarget_ID, C_DocType_ID, daymonth, daymonth, CN_Type, dateordered2,dateordered3, User1_ID,
                     User2_ID , c_bpartner_id,crm_description,daynow)
            ...
            line_body += """<_0:operation preCommit="false" postCommit="false">
                    ...
                    </_0:operation>"""  % ( org_id, C_Tax_ID,total_amount,total_amount,total_amount, C_Charge_ID) #, cn_on_product
        ...
        for partner in partner_ids:
            ...
            payment_body = """<_0:serviceType>CreateCompleteCreditNote</_0:serviceType>
                <_0:operations>
                    ...
                    </_0:operation>"""  % ( org ,C_DocTypeTarget_ID, C_DocType_ID, daymonth, daymonth, CN_Type, dateordered2,dateordered3,
            ...
            for line_rec in vals:
                if partner == line_rec[0]:
                    ...
                    </_0:operation>"""  % ( org, C_Tax_ID,PriceList,PriceList,PriceList, C_Charge_ID) #, cn_on_product
...
class credit_note_line(models.Model):
    ...
    cn_on_product = fields.Many2one('product.product', string='CN On Product' ,  domain="[('company_id','=',company_id),('type','in',('product','consu'))]")
    ...
    def process_update_erp_c_elementvalue_queue(self):
        ...
        if config_id:
            ...
            try:
                ...
                and IsSummary = 'N' and c_element_id in ('1000005','1000013') " 
