...
class ticket_booking(models.Model):
    ...
    _description = "Ticket Booking Channel"
    _order  = 'id desc'
    ...
    #     print "RRRRRRRRRRRRRRRRRRRRRR" ,grade
    #     return grade
    ...
    def approve_ticket_booking_manager(self):
        ...
        if str(self.manager_id.work_email) == str(self.env.user.login) or frontdesk_manager or self.env.uid == 1:
            ...
            raise UserError("Only %s 's manager (%s) or Admin can approve his Request" %(self.employee_id.name,self.employee_id.parent_id.name))
        # self.write({'state': 'approved'})
        # self.send_approved_mail()
    ...
    def action_submit(self):
        ...
        self.name = ( 'Hotel Booking '  if self.booking_type == 'hotel' else ('Travel ' + transport_mode ) ) + '(' + fromdate + ')' + name
        self.state = 'created'
        self.send_user_mail()
    ...
    def send_user_mail(self):
        ...
        if self.booking_type == 'hotel':
            body = """
                <ul>
                    <li>Booking reason    &nbsp;   : <span>%s</span></li>
                    <li>From Date    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  : <span>%s</span></li>
                    <li>Return Date   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <span>%s</span></li>
                    <li>To Location &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  : <span>%s</span></li>
                    <li>Description &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <span>%s</span></li>
                </ul>
        ...
        if self.booking_type == 'travel':
            body = """
                    <ul>
                        ...
                        <li>From Date    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  : <span>%s</span></li>
                        <li>Return Date   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <span>%s</span></li>
                        <li>From Location  &nbsp;&nbsp;&nbsp;   : <span>%s</span></li>
                        <li>To Location &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  : <span>%s</span></li>
                        <li>Transport Mode    &nbsp;  : <span>%s</span></li>
                        <li>Description &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <span>%s</span></li>
                    </ul>

            """ % (self.action_booking_reason(),fromdate  or '', todate or '', self.from_location  or '', self.to_location  or '', transport_mode  or '', self.description or '')
        ...
        composed_mail = self.env['mail.mail'].sudo().create({
                'model': self._name,
                'res_id': self.id,
                'email_to': ",".join(managers), #manager.work_email,
                'subject': subject,
                'body_html': full_body,
                'auto_delete': False,
                # 'priority_mail': True,
    ...
    def send_approved_mail(self):
            ...
            * {font-family: "Helvetica Neue", Helvetica, sans-serif, Arial !important;}
            ...
            <h3>Following are the details as below listed. </h3>
                ...
                <ul>
                    ...
                    <li>From Location    : <span>%s</span></li>
                    <li>To Location &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  : <span>%s</span></li>
                    <li>Mode Of Transport    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  : <span>%s</span></li>
                    <li>Description &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <span>%s</span></li>
                </ul>
        ...
        composed_mail = self.env['mail.mail'].sudo().create({
                'model': self._name,
                'res_id': self.id,
                'email_to': ",".join(tech_partners), #manager.work_email,
                'subject': subject,
                'body_html': full_body,
                'auto_delete': False,
            })
    ...
    def send_rejected_mail(self):
        ...
        composed_mail = self.env['mail.mail'].sudo().create({
                'model': self._name,
                'res_id': self.id,
                'email_to': self.employee_id.work_email, #manager.work_email,
                'subject': subject,
                'body_html': full_body,
                'auto_delete': False,
            })
